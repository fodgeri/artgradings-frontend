...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      // `database.types.ts` is generated by `npm run db:types` and is pure
      // type declarations — it emits no runtime code to cover, and counting it
      // would only dilute the numbers with a file nobody writes by hand.
      exclude: [
        "**/*.test.{ts,tsx}",
        "**/*.d.ts",
